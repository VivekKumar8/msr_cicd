...
<div id="heading" class="breadcrumb">
    CloudStreams &gt; Administration &gt; Add New OAuth Token Configuration
</div>
<div id="container">
<!--
    %switch action%
...
-->
	...
	<form action="oauthTokens.dsp" method="post">
        <table class="tableView">
            <thead>
            <tr>
                <th colspan="2" class="heading">OAuth Token Configuration</th>
            </tr>
            </thead>
            <tbody>
            <tr>
            ...
            <tr>
				...
				placeholder="******" onclick="this.select()" /></td>
            </tr>
	...
	<input type="hidden" name="passwordChange" value="">
        <input type="hidden" id="action" name="action" value="addAlias"/>
